...
require (
	...
	golang.singingcat.net/apis/base v1.1.2258 // indirect
	golang.singingcat.net/apis/scweb v1.1.2258 // indirect
	golang.singingcat.net/apis/singingcat v1.1.2258 // indirect
